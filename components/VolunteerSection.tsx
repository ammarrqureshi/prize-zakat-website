    ...
    <section className="mb-32">
      <div className="relative mx-auto max-w-full px-4 lg:max-w-7xl">
        <div className="relative w-full bg-white">
          ...
          <div className="relative z-20 mb-8 md:overflow-hidden rounded-xl rounded-tl-3xl bg-accent-4/20 pt-20 pb-20 lg:rounded-3xl lg:rounded-tl-[120px]">
            <div className="relative z-10 px-6 md:px-16">
              <form action="" className="flex justify-center max-sm:flex-col  max-sm:gap-4 lg:space-x-5">
                ...
                <Link
                  href="/contact"
                  className="flex gap-4 items-center justify-between rounded-lg bg-accent-2 py-4 px-6 text-white hover:bg-accent-1 lg:rounded-xl"
                >
